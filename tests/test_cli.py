...
class TestCheckoutNewBranch(unittest.TestCase):
    ...
    def test_checkout_new_branch(self):
        ...
        with patch("pkg_95120.cli.git.Repo", return_value=mock_repo_instance):
...
class TestZMain(unittest.TestCase):
    ...
    @patch("pkg_95120.cli.start_thread")
    ...
    @patch("pkg_95120.cli.checkout_new_branch", return_value="new-branch")
    ...
    @patch("pkg_95120.cli.get_owner_repo_revs")
    @patch("pkg_95120.cli.update_pre_commit_config")
    @patch("pkg_95120.cli.checkout_new_branch")
    @patch("pkg_95120.cli.push_commit")
    @patch("pkg_95120.cli.create_pr")
    @patch("pkg_95120.cli.Github")
